...
def test_parse_if_as_expression() -> None:
    ...
    assert parse(binary_operation) == ast.BinaryOp(L,ast.Literal(L,1), "+", ast.IfExpression(L,ast.Identifier(L,"true"), ast.Literal(L,2), ast.Literal(L,3)))
...
def test_nested_if() -> None:
    ...
    assert parse(if_clause) == ast.IfExpression(L,ast.Identifier(L,"a"), ast.IfExpression(L,ast.Identifier(L,"true"), ast.Literal(L,2), ast.Literal(L,3)), None)
...
def test_variable_declaration_top() -> None:
    ...
    assert parse(declaration) == ast.Declaration(L,variable=ast.Identifier(L,"x"), value=ast.Literal(L,5))
...
def test_variable_declaration_block() -> None:
    ...
    assert parse(block) == ast.Block(L,[], ast.Declaration(L,variable=ast.Identifier(L,"x"), value=ast.Literal(L,5)))
...
def test_block_result() -> None:
    ...
    assert parse(block) == ast.Block(L,[ast.Declaration(L,ast.Identifier(L,"x"), ast.Literal(L,5))], ast.Identifier(L,"x"))
...
def test_block_no_result() -> None:
    ...
    assert parse(block) == ast.Block(L,[ast.Declaration(L,ast.Identifier(L,"x"), ast.Literal(L,5)), ast.Identifier(L,"x")], ast.Literal(None, None))
...
def test_block_automatic_semicolons() -> None:
    ...
    assert parse(block) == ast.Block(L,[ast.Block(L,[], ast.Declaration(L,ast.Identifier(L,"x"), ast.Literal(L,4))), ast.Block(L,[], ast.Identifier(L,"a"))], ast.Block(L,[], ast.Declaration(L,ast.Identifier(L,"x"), ast.Literal(L,5))))
...
def test_block_automatic_semicolons_3() -> None:
    ...
    assert parse(block) == ast.Block(L,[ast.IfExpression(L,ast.Identifier(L,"true"), ast.Block(L,[], ast.Identifier(L,"a")), None)], ast.Identifier(L,"b"))
...
def test_block_automatic_semicolons_6() -> None:
    ...
    assert parse(block) == ast.Block(L,[ast.IfExpression(L,ast.Identifier(L,"true"), ast.Block(L,[], ast.Identifier(L,"a")), None), ast.Identifier(L,"b")], ast.Identifier(L,"c"))
...
def test_block_automatic_semicolons_7() -> None:
    ...
    assert parse(block) == ast.Block(L,[ast.IfExpression(L,ast.Identifier(L,"true"), ast.Block(L,[], ast.Identifier(L,"a")), ast.Block(L,[], ast.Identifier(L,"b")))], ast.Identifier(L,"c"))
